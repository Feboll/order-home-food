...
if (process.env.NODE_ENV === "production") {
  ...
  app.get("*", (req, res) => {
    res.sendFile(path.join("../", "client-side", "build", "index.html"));
  });
}
...
mongoose
  .connect(
    ...
    `mongodb+srv://foodhubuser:wpfedJQdfBrcKgOr@foodhub.h8jov.mongodb.net/foodhub?retryWrites=true&w=majority`
  )
  .then((result) => {
